            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    @else
                        @if ($users->isEmpty())
                            <div class="flex justify-center items-center">
                                <p class="text-sm font-bold text-red-600">Uh-Ah! No results found! Check spelling or character and try again..</p>
                            </div>
                        @else
                            <table class="border-collapse table-auto w-full text-sm">
                                <thead>
                                    <tr>
                                        ...
                                        <th id="size-hidde" class="border-b font-medium p-4 pl-8 pt-0 pb-3 text-slate-400 text-left">Created At</th>
                                        <th id="size-hidde" class="border-b font-medium p-4 pl-8 pt-0 pb-3 text-slate-400 text-left">Updated At</th>
                                    </tr>
                                </thead>
                                <tbody class="bg-white">
                                    ...
                                    @foreach ($users as $user)
                                        <tr>
                                            ...
                                            <td id="size-hidde" class="border-b border-slate-100 dark:border-slate-700 p-4 pl-8 text-slate-500 dark:text-slate-400">
                                                {{ $user->email }}
                                            </td>
                                            <td class="border-b border-slate-100 dark:border-slate-700 p-4 pl-8 text-slate-500 dark:text-slate-400">
                                                {{ $user->phone_number }}
