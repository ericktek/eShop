 ...
 <section>
    <div class="pb-16 pt-20">
        ...
        <div class="flex justify-center items-center">
            ...
            <p class="ml-3 text-sm font-bold text-red-500">{{ $status }}</p>
        ...
        <div class="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0">
            ...
            <div class="rounded-lg md:w-2/3">
                ...
                <div
                    ...
                    <img
                    src="{{ Storage::url($result->post->featured_image) }}"
                    alt="product-image"
                        ...
                        <div
                            ...
                            <div class="inline-block lg:ml-20  space-x-4 bg-purple-500 p-1 rounded">
                                <h1 class="text-sm text-white font-bold">
                                    {{ number_format($result->post->price, 0, '.', ',') }}
                                    Tsh
                                </h1>

                            </div>
                            <form action="{{ route('removeCartItemR', ['result' => $result->id]) }}" method="POST">
                                @csrf
                                @method('DELETE')
