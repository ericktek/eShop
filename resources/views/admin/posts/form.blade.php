        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <a style="background: black" href="{{ route('posts.index') }}" class="bg-blue-500 text-white px-4 py-2 rounded-md">BACK</a>
                    <div class="p-6 text-gray-900">
                    ...
                    <form method="post"
                        ...
                        <div>
                            ...
                            <x-input id="price" name="price" type="text" class="mt-1 block w-full" required
                                     :value="$post->price ?? old('price')" autofocus />
                        ...
                        <div>
                            ...
                            <label class="block mt-2">
                                ...
                                " />
                                <span style="color:red;">Max Image Size: 5MB</span>
                            </label>
